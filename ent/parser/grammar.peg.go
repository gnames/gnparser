	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l1121:
				...
				add(ruleMultipleSpace, position1120)
			}
			return true
		l1119:
		...
		func() bool {
			...
			l1125:
				add(ruleSingleSpace, position1124)
			}
			return true
		l1123:
		...
		func() bool {
			...
			l1129:
				add(ruleOtherSpace, position1128)
			}
			return true
		l1127:
