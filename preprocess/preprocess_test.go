...
// var _ = DescribeTable("Approximation",
// 	func(s string, expected1 string, expected2 string) {
// 		bs := []byte(s)
// 		i := Approximation([]byte(s))
// 		Expect(string(bs[0:i])).To(Equal(expected1))
// 		Expect(string(bs[i:])).To(Equal(expected2))
// 	},
// 	Entry("No match", "Homo sapiens", "Homo sapiens", ""),
// 	Entry("No match without space", "Homo spsapiens", "Homo spsapiens", ""),
// 	Entry("Match sp", "Homo sp sapiens", "Homo", " sp sapiens"),
// 	Entry("Match sp.", "Homo sp. sapiens", "Homo", " sp. sapiens"),
// 	Entry("Match sp.nr", "Homo sp.nr sapiens", "Homo", " sp.nr sapiens"),
// 	Entry("Match end", "Homo sp", "Homo", " sp"),
// 	Entry("Match species", "Homo species sapiens", "Homo", " species sapiens"),
// 	Entry("Match aff", "Homo sapiens aff alba", "Homo sapiens", " aff alba"),
// 	Entry("Match aff.", "Homo sapiens aff. alba", "Homo sapiens", " aff. alba"),
// 	Entry("Match sp.aff.", "Homo sapiens sp.aff.alba", "Homo sapiens", " sp.aff.alba"),
// 	Entry("Match monst.", "Homo sapiens monst.alba", "Homo sapiens", " monst.alba"),
// 	Entry("No match monst", "Homo sapiens monst alba", "Homo sapiens monst alba", ""),
// 	Entry("Match ?", "Homo sapiens ? alba", "Homo sapiens", " ? alba"),
// 	Entry("Match ?", "Homo sapiens ?alba", "Homo sapiens", " ?alba"),
// 	Entry("No match ? middle", "Homo sap?iens alba", "Homo sap?iens alba", ""),
// 	Entry("No match ? word end", "Homo sapiens? alba", "Homo sapiens? alba", ""),
// )

var _ = DescribeTable("IsVirus",
