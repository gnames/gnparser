	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l300:
				...
				add(ruleWordStartsWithDigit, position284)
			}
			return true
		l283:
		...
		func() bool {
			...
			l312:
				...
				add(ruleWordApostr, position311)
			}
			return true
		l310:
		...
		/* 96 LowerCharExtended <- <('æ' / 'œ' / 'à' / 'â' / 'å' / 'ã' / 'ä' / 'á' / 'ç' / 'č' / 'é' / 'è' / 'ë' / 'í' / 'ì' / 'ï' / 'ň' / 'ñ' / 'ñ' / 'ó' / 'ò' / 'ô' / 'ø' / 'õ' / 'ö' / 'ú' / 'ù' / 'ü' / 'ŕ' / 'ř' / 'ŗ' / 'ſ' / 'š' / 'š' / 'ş' / 'ž')> */
		func() bool {
