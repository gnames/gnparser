...
* Add: .markdownlint.json configuration for markdown linting.
* Add: Format README.md with markdownlint (asterisk-style lists).
* Add: Update Go to 1.25.1 and update all dependencies.
* Add: Update flake.nix to support multiple systems (x86_64-linux,
  aarch64-linux, x86_64-darwin, aarch64-darwin).
* Add: Update flake.lock to nixos-unstable.
* Add: .gitignore entry for /bin/** directory.
